...
pub struct Tank {
    ...
    #[serde(rename = "deltaQ", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub delta_q: Option<Option<f64>>,
...
impl Tank {
    pub fn new(simulation_object_id: i32, last_updated: String, name: String) -> Tank {
        Tank {
