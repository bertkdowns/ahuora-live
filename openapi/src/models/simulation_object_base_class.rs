...
pub struct SimulationObjectBaseClass {
...
impl SimulationObjectBaseClass {
    pub fn new(simulation_object_id: i32, last_updated: String, name: String) -> SimulationObjectBaseClass {
        SimulationObjectBaseClass {
