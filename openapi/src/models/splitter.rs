...
pub struct Splitter {
    ...
    #[serde(rename = "outCount", skip_serializing_if = "Option::is_none")]
    pub out_count: Option<i32>,
    #[serde(rename = "calculationMode", skip_serializing_if = "Option::is_none")]
    pub calculation_mode: Option<models::SplitterCalculationModeEnum>,
...
impl Splitter {
    pub fn new(simulation_object_id: i32, last_updated: String, name: String) -> Splitter {
        Splitter {
