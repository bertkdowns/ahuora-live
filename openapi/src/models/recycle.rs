...
pub struct Recycle {
    ...
    #[serde(rename = "convergenceHistory", skip_serializing_if = "Option::is_none")]
    pub convergence_history: Option<Box<models::PropertySet>>,
    #[serde(rename = "convergenceParameters", skip_serializing_if = "Option::is_none")]
    pub convergence_parameters: Option<Box<models::PropertySet>>,
    ...
    #[serde(rename = "converged", skip_serializing_if = "Option::is_none")]
    pub converged: Option<bool>,
    #[serde(rename = "copyOnStreamDataError", skip_serializing_if = "Option::is_none")]
    pub copy_on_stream_data_error: Option<bool>,
    #[serde(rename = "calculationMode", skip_serializing_if = "Option::is_none")]
    pub calculation_mode: Option<models::RecycleCalculationModeEnum>,
    #[serde(rename = "internalCounter", skip_serializing_if = "Option::is_none")]
    pub internal_counter: Option<Vec<i32>>,
    #[serde(rename = "iterationCount", skip_serializing_if = "Option::is_none")]
    pub iteration_count: Option<i32>,
    #[serde(rename = "iterationsTaken", skip_serializing_if = "Option::is_none")]
    pub iterations_taken: Option<i32>,
    #[serde(rename = "values", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub values: Option<Option<serde_json::Value>>,
    ...
    #[serde(rename = "wegsteinParameters", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub wegstein_parameters: Option<Option<i32>>,
}

impl Recycle {
    pub fn new(simulation_object_id: i32, last_updated: String, name: String) -> Recycle {
        Recycle {
            ...
            converged: None,
            copy_on_stream_data_error: None,
