...
pub struct Spec {
    ...
    #[serde(rename = "calculateTargetObject", skip_serializing_if = "Option::is_none")]
    pub calculate_target_object: Option<bool>,
    ...
    #[serde(rename = "targetObjectData", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub target_object_data: Option<Option<i32>>,
    #[serde(rename = "sourceObjectData", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub source_object_data: Option<Option<i32>>,
    #[serde(rename = "customSourceObject", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub custom_source_object: Option<Option<i32>>,
    #[serde(rename = "customTargetObject", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub custom_target_object: Option<Option<i32>>,
}

impl Spec {
    pub fn new(simulation_object_id: i32, last_updated: String, name: String) -> Spec {
        Spec {
            ...
            custom_source_object: None,
            custom_target_object: None,
        }
    }
}
