...
pub struct PatchedHeatExchanger {
    ...
    #[serde(rename = "shellAndTubeProps", skip_serializing_if = "Option::is_none")]
    pub shell_and_tube_props: Option<Box<models::PropertySet>>,
    ...
    #[serde(rename = "foulingFactor", skip_serializing_if = "Option::is_none")]
    pub fouling_factor: Option<i32>,
    #[serde(rename = "heatProfile", skip_serializing_if = "Option::is_none")]
    pub heat_profile: Option<Vec<i32>>,
    #[serde(rename = "temperatureProfileCold", skip_serializing_if = "Option::is_none")]
    pub temperature_profile_cold: Option<Vec<i32>>,
    #[serde(rename = "temperatureProfileHot", skip_serializing_if = "Option::is_none")]
    pub temperature_profile_hot: Option<Vec<i32>>,
    #[serde(rename = "exchangerType", skip_serializing_if = "Option::is_none")]
    pub exchanger_type: Option<models::ExchangerTypeEnum>,
    #[serde(rename = "deltaP", skip_serializing_if = "Option::is_none")]
    pub delta_p: Option<i32>,
    #[serde(rename = "calculationMode", skip_serializing_if = "Option::is_none")]
    pub calculation_mode: Option<models::HeatExchangerCalculationModeEnum>,
    #[serde(rename = "definedTemperature", skip_serializing_if = "Option::is_none")]
    pub defined_temperature: Option<models::DefinedTemperatureEnum>,
    #[serde(rename = "flowDirection", skip_serializing_if = "Option::is_none")]
    pub flow_direction: Option<models::FlowDirectionEnum>,
    ...
    #[serde(rename = "accumulationStreamCold", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub accumulation_stream_cold: Option<Option<i32>>,
    #[serde(rename = "accumulationStreamHot", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub accumulation_stream_hot: Option<Option<i32>>,
}

impl PatchedHeatExchanger {
    pub fn new() -> PatchedHeatExchanger {
        PatchedHeatExchanger {
            ...
            fouling_factor: None,
            heat_profile: None,
            temperature_profile_cold: None,
            temperature_profile_hot: None,
            exchanger_type: None,
            delta_p: None,
            calculation_mode: None,
            defined_temperature: None,
            flow_direction: None,
            flowsheet_owner: None,
            property_package: None,
            accumulation_stream: None,
            accumulation_stream_cold: None,
            accumulation_stream_hot: None,
        }
    }
}
