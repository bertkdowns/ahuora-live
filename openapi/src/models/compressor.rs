...
pub struct Compressor {
    ...
    pub calculation_mode: Option<models::CompressorCalculationModeEnum>,
    #[serde(rename = "thermodynamicPath", skip_serializing_if = "Option::is_none")]
    pub thermodynamic_path: Option<models::ThermodynamicPathEnum>,
...
impl Compressor {
    pub fn new(simulation_object_id: i32, last_updated: String, name: String) -> Compressor {
        Compressor {
