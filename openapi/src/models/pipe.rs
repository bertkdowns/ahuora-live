...
pub struct Pipe {
    ...
    #[serde(rename = "maxPressureIterations", skip_serializing_if = "Option::is_none")]
    pub max_pressure_iterations: Option<i32>,
    #[serde(rename = "maxTemperatureIterations", skip_serializing_if = "Option::is_none")]
    pub max_temperature_iterations: Option<i32>,
    #[serde(rename = "triggerFlashP", skip_serializing_if = "Option::is_none")]
    pub trigger_flash_p: Option<i32>,
    #[serde(rename = "triggerFlashT", skip_serializing_if = "Option::is_none")]
    pub trigger_flash_t: Option<i32>,
    #[serde(rename = "calculationMode", skip_serializing_if = "Option::is_none")]
    pub calculation_mode: Option<models::PipeCalculationModeEnum>,
    #[serde(rename = "pressureDropCorrelation", skip_serializing_if = "Option::is_none")]
    pub pressure_drop_correlation: Option<models::PressureDropCorrelationEnum>,
...
impl Pipe {
    pub fn new(simulation_object_id: i32, last_updated: String, name: String) -> Pipe {
        Pipe {
            ...
            max_temperature_iterations: None,
            trigger_flash_p: None,
            trigger_flash_t: None,
            calculation_mode: None,
            pressure_drop_correlation: None,
