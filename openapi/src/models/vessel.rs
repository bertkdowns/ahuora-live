...
pub struct Vessel {
    ...
    pub calculation_mode: Option<models::CalculationMode16dEnum>,
    #[serde(rename = "deltaQ", skip_serializing_if = "Option::is_none")]
    pub delta_q: Option<f64>,
    #[serde(rename = "dimensionRatio", skip_serializing_if = "Option::is_none")]
    pub dimension_ratio: Option<i32>,
    #[serde(rename = "residenceTime", skip_serializing_if = "Option::is_none")]
    pub residence_time: Option<i32>,
    #[serde(rename = "surgeFactor", skip_serializing_if = "Option::is_none")]
    pub surge_factor: Option<f64>,
    #[serde(rename = "prevMolarMass", skip_serializing_if = "Option::is_none")]
    pub prev_molar_mass: Option<f64>,
    #[serde(rename = "C")]
    pub c: i32,
    #[serde(rename = "K")]
    pub k: f64,
...
impl Vessel {
    pub fn new(simulation_object_id: i32, last_updated: String, name: String, c: i32, k: f64, vgi: i32, vmax: i32) -> Vessel {
        Vessel {
