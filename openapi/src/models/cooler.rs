...
pub struct Cooler {
    ...
    pub prev_molar_mass: Option<i32>,
    #[serde(rename = "calculationMode", skip_serializing_if = "Option::is_none")]
    pub calculation_mode: Option<models::CoolerCalculationModeEnum>,
...
impl Cooler {
    pub fn new(simulation_object_id: i32, last_updated: String, name: String) -> Cooler {
        Cooler {
