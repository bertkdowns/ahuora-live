...
pub struct PatchedValve {
    ...
    #[serde(rename = "DIV", skip_serializing_if = "Option::is_none")]
    pub div: Option<f64>,
    ...
    pub fi: Option<f64>,
    #[serde(rename = "HALF_P1", skip_serializing_if = "Option::is_none")]
    pub half_p1: Option<f64>,
    ...
    #[serde(rename = "xT", skip_serializing_if = "Option::is_none")]
    pub x_t: Option<f64>,
