...
pub struct PatchedEnergyRecycle {
    ...
    #[serde(rename = "accelerationMethod", skip_serializing_if = "Option::is_none")]
    pub acceleration_method: Option<models::AccelerationMethodEnum>,
    ...
    #[serde(rename = "convergenceParametersE", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub convergence_parameters_e: Option<Option<i32>>,
    #[serde(rename = "convergenceHistoryE", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub convergence_history_e: Option<Option<i32>>,
}

impl PatchedEnergyRecycle {
    pub fn new() -> PatchedEnergyRecycle {
        PatchedEnergyRecycle {
            ...
            convergence_parameters_e: None,
            convergence_history_e: None,
        }
    }
}
