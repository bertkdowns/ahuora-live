...
pub struct Pump {
    ...
    #[serde(rename = "impellerDiameter", skip_serializing_if = "Option::is_none")]
    pub impeller_diameter: Option<String>,
    #[serde(rename = "impellerSpeed", skip_serializing_if = "Option::is_none")]
    pub impeller_speed: Option<String>,
    #[serde(rename = "pumpType", skip_serializing_if = "Option::is_none")]
    pub pump_type: Option<String>,
    #[serde(rename = "curveFlow", skip_serializing_if = "Option::is_none")]
    pub curve_flow: Option<String>,
    #[serde(rename = "fixOnDeltaP", skip_serializing_if = "Option::is_none")]
    pub fix_on_delta_p: Option<bool>,
    #[serde(rename = "ignorePhase", skip_serializing_if = "Option::is_none")]
    pub ignore_phase: Option<bool>,
    #[serde(rename = "calculationMode", skip_serializing_if = "Option::is_none")]
    pub calculation_mode: Option<models::PumpCalculationModeEnum>,
...
impl Pump {
    pub fn new(simulation_object_id: i32, last_updated: String, name: String) -> Pump {
        Pump {
