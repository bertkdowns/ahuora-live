...
**shell_and_tube_props** | Option<[**models::PropertySet**](PropertySet.md)> |  | [optional]
...
**fouling_factor** | Option<**i32**> |  | [optional]
**heat_profile** | Option<**Vec<i32>**> |  | [optional]
**temperature_profile_cold** | Option<**Vec<i32>**> |  | [optional]
**temperature_profile_hot** | Option<**Vec<i32>**> |  | [optional]
**exchanger_type** | Option<[**models::ExchangerTypeEnum**](ExchangerTypeEnum.md)> |  | [optional]
**delta_p** | Option<**i32**> |  | [optional]
**calculation_mode** | Option<[**models::HeatExchangerCalculationModeEnum**](HeatExchangerCalculationModeEnum.md)> |  | [optional]
**defined_temperature** | Option<[**models::DefinedTemperatureEnum**](DefinedTemperatureEnum.md)> |  | [optional]
**flow_direction** | Option<[**models::FlowDirectionEnum**](FlowDirectionEnum.md)> |  | [optional]
**flowsheet_owner** | Option<**i32**> |  | [optional]
**property_package** | Option<**i32**> |  | [optional]
**accumulation_stream** | Option<**i32**> |  | [optional]
**accumulation_stream_cold** | Option<**i32**> |  | [optional]
**accumulation_stream_hot** | Option<**i32**> |  | [optional]
